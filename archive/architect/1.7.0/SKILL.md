...
| `skill-author` | Editing robium's own skills (fresh authoring, hardening from learnings; external-repo mining moved to `mining`). Not an app-building skill. |
...
- 1.7.0 (2026-08-02): routing table (Verification & meta) gains the new
