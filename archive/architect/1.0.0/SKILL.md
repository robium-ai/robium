...
- **Always produce or update `docs/architecture-brief.md` in the app repo.** It
...
**4. Scaffold.** Lay out the repo per `references/scaffold-patterns.md` (ROS 2
app layout or LeRobot app layout), then hand each phase to its skill.
...
| `skill-updater` | End-of-session absorption: folding this session's gotchas back into the robium skills. Not an app-building skill. |
