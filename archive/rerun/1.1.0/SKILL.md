...
- **Never write archetype names, constructor arguments, or CLI flags from
  memory.** The archetype list (`Points3D`, `Image`, `Scalars`,
...
**Embedding in a Gradio demo.** The official `gradio_rerun` component (PyPI
...
see `huggingface` for the demo-hosting side of that pairing.
...
- **0.34.1 API notes — don't reach for older Rerun API names.** The scalar
