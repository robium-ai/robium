...
pages, fetched directly this session (method noted per section below).
...
## GPU, driver, CPU, RAM, storage (direct fetch this session)
...
## Supported operating systems (direct fetch this session)
...
installation page this session.
...
## Headless + livestream networking (direct fetch this session)
