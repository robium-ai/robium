...
- **robium-apps and robium-website repos are PRIVATE** — the site must not link to them or claim they're public.
...
```bash
  # apps/ paths moved to the private robium-apps repo — no public deep-links.
...
apps/ moved to the private robium-apps repo in the 2026-08-03 split —
