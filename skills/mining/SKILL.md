...
description: >
  ...
  absorbing robium's own session learnings (learning-loop) or fresh skill
  authoring mechanics (skill-author).
---
...
- 0.1.2 (2026-08-03): style pass; removed em dashes throughout (no content changes).
